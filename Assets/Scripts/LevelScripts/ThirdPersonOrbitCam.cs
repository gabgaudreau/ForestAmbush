...
{
    [SerializeField]
    Camera menuCamera, playerCamera;
    [SerializeField]
    GameObject menu;
    ...
    private float angleH = 160;                                          // Float to store camera horizontal angle related to mouse movement.
    ...
    // Game Over Screen
    private bool gameover;                                              // Play Once
    public Image panel;                                                 // Game Over Panel
    public Text panelText;                                              // Game Over Text
    private AudioSource gameOverSound;                                  // Game Over sound
    ...
    void LateUpdate()
    {
        ...
        if (player.GetComponent<PlayerManager>().dead && !gameover)
        {
            gameover = true;
            gameOverSound.Play();
    ...
    // Make Game Over screen invisible
    void ResetPanel()
    {
    ...
    // Fade in Game Over screen and Reset Game
    public IEnumerator GameOver(string text)
    {
        ...
        for (int i = 0; i < 50; i++)
        {
            panel.color = new Color(panel.color.r, panel.color.g, panel.color.b, i / 50.0f);
            panelText.color = new Color(panelText.color.r, panelText.color.g, panelText.color.b, i / 50.0f);
    ...
    // Reset player parameters and return to menu
    void ResetGame()
    {
